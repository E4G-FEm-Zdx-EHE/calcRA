...
public class RomanArabianCalc {
    ...
    public static void main (String[] args) {
        ...
        // Считывается строка userInput которая введена с клавиатуры
        String userInput = scanner.nextLine();
        // Создается пустой символьный массив 10ю символов under_char
        char[] under_char = new char[10];
        // Заполняется символьный массив символами строки введеная с клавиатуры после знак операции
